...
export function attachWebSocketErrorHandler(
  socket: Pick<WebSocket, "close" | "on">,
): void {
...
function edgeFadeCustomPropertyBootstrapScript(): string {
  return `(() => {
  try {
...
function sidebarHistoryControlsBootstrapScript(): string {
  return `(() => {
